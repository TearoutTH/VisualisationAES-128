...
public class KeyExpander {
    ...
    private static short[][] roundKeys = new short[4][44]; //a set of round keys

    public static short[][] getRoundKeys() {
        return roundKeys;
    }

    public static void setRoundKeys(short[][] roundKeys) {
        KeyExpander.roundKeys = roundKeys;
    }
